...
const seedDB = async() => {
    ...
    for(let i = 0; i< 50; i++) {
        ...
        const camp = new Campground({
            ...
            description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis nemo excepturi qui maiores corporis vero recusandae esse eligendi voluptas distinctio. Nihil nam ipsa consectetur at quod saepe dicta delectus ratione.',
            price
        })
        await camp.save();
    }
